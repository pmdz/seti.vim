...
hi Pmenu                        ctermfg=NONE  ctermbg=NONE  cterm=NONE          guifg=NONE      guibg=#28364C   gui=NONE
hi PmenuSel                     ctermfg=NONE  ctermbg=74    cterm=NONE          guifg=NONE      guibg=#4B72B2   gui=NONE
hi IncSearch                    ctermfg=16    ctermbg=74    cterm=NONE          guifg=#151718   guibg=#55b5db   gui=NONE
hi Search                       ctermfg=NONE  ctermbg=NONE  cterm=underline     guifg=NONE      guibg=#9A2392   gui=underline
